  ...
  <div class="app-container">
    ...
    <el-tabs type="border-card" @tab-click="handleClick">
          ...
          <el-row :gutter="12">
            <el-col :span="6">
              <el-form-item label="网站头像">
                <el-upload class="avatar-uploader1" action ref="upload" :show-file-list="false" :disabled="!canUpdate"
            ...
            <el-col :span="6">
              <el-form-item label="游客头像" prop="touristAvatar">
                <el-upload class="avatar-uploader1" action ref="upload" :show-file-list="false" :disabled="!canUpdate"
                  :action="uploadPictureHost" :before-upload="uploadBefore" :http-request="touristUpload">
                  <img style="width: 100px;height: 100px" v-if="form.touristAvatar" :src="form.touristAvatar"
                    class="avatar1">
                  <i v-else class="el-icon-plus avatar-uploader-icon1"></i>
                </el-upload>
              </el-form-item>
            ...
            <el-col :span="10">
              <el-form-item label="登录方式">
                <el-checkbox-group v-model="loginTypeLists">
                  <el-checkbox border v-for="item in loginDictList" :key="item.value" :label="item.value"
                    style="margin-left:10px;" :disabled="item.value == 1">
                    {{ item.label }}
                  </el-checkbox>
                </el-checkbox-group>
              </el-form-item>
      ...
      <el-tab-pane>
        ...
        <el-form style="margin-left: 20px;" label-position="left" :model="form" label-width="80px" ref="from">
          <el-form-item label="作者头像">
            <el-upload class="avatar-uploader1" action ref="upload" :show-file-list="false" :disabled="!canUpdate"
              :action="uploadPictureHost" :before-upload="uploadBefore" :http-request="authorUpload">
        ...
        <el-form style="margin-left: 20px;" label-position="left" :model="form" label-width="90px" ref="from">
          <el-row :gutter="24">
            <el-col :span="4">
              <el-form-item label="支付宝">
                <el-upload class="avatar-uploader1" action ref="upload" :show-file-list="false" :disabled="!canUpdate"
                  :action="uploadPictureHost" :before-upload="uploadBefore" :http-request="aliPayMethod">
            ...
            <el-col :span="4">
              <el-form-item label="微信">
                <el-upload class="avatar-uploader1" action ref="upload" :show-file-list="false" :disabled="!canUpdate"
                  :action="uploadPictureHost" :before-upload="uploadBefore" :http-request="weiXinPayMethod">
          ...
          <el-row :gutter="24">
            <el-form-item label="网站评论">
              <el-radio v-for="item in openDictList" :key="item.id" v-model="form.openComment" :label="item.value" border
      ...
      <el-tab-pane>
        ...
        <el-form style="margin-left: 20px;" label-position="left" :model="form" label-width="80px" :rules="rules"
          ref="form">
