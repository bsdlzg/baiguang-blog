<template>
  <div class="dashboard-editor-container">
            ...
            <el-table-column label="标题" width="300px">
              <template slot-scope="scope">
                <el-link style="overflow: hidden;text-overflow: ellipsis;white-space: nowrap;" :underline="false"
                         @click="goArticleInfo(scope.row)">{{ scope.row.title }}
                </el-link>
              </template>
            </el-table-column>
            <el-table-column label="阅读量" width="100px" prop="quantity" align="center"/>
          </el-table>
        </el-card>
      </el-col>
    ...
    <!--  首页仪表盘弹框通知  -->
    <el-dialog title="通知" :close-on-click-modal="false" :visible.sync="centerDialogVisible" width="50%"
               :before-close="closeNotificationDialogVisible" center>
...
export default {
  name: 'DashboardAdmin',
  components: {GithubCorner, PanelGroup},
  data() {
    return {
      tagDTOList: [],
      categoryChart: null,
