...
public class WebSocketSimpleChannelInboundHandler extends SimpleChannelInboundHandler<Object> {
    ...
    private void handWebsocketFrame(ChannelHandlerContext ctx, WebSocketFrame frame) {
        ...
        try {
            ...
            ImMessageService imMessageService = getImMessageService();
...
//        ctx.channel().config().setWriteBufferLowWaterMark();
    ...
    private void handHttpRequest(ChannelHandlerContext ctx, FullHttpRequest request) {
        ...
        if (handshaker == null) {
            ...
            ImMessageService imMessageService = getImMessageService();
            List<ImOnlineUserVO> onlineUserList = imMessageService.selectPublicOnlineUserList(userList);
    ...
    @NotNull
    private static ImMessageService getImMessageService() {
        ImMessageService imMessageService = SpringUtils.getBean(ImMessageService.class);
